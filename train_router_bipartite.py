...
class BipartiteRouterGNN(nn.Module):
    def __init__(self, query_dim, num_tasks, num_prompts, num_models, hidden_dim):
        ...
        self.candidate_proj = nn.Linear(96, query_dim)
    ...
    def forward(self, query_emb, task_id, prompt_id, model_id):
        ...
        candidate_emb = torch.cat([t_emb, p_emb, m_emb], dim=-1)  # 96
